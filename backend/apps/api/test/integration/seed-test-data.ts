...
}: typeof import('../../../../packages/database/src/seed-dates') = require('../../../../packages/database/src/seed-dates.ts');
...
export async function seedIntegrationTestData(prisma: PrismaClient) {
  ...
  await prisma.chat.createMany({
    data: [
      ...
      },
      {
        ...
        meetupMode: 'hybrid',
        currentStep: 1,
        meetupStartsAt: new Date('2026-04-26T17:45:00.000Z'),
      },
      {
        id: 'evening-chat-r-wild-night',
        kind: 'meetup',
        origin: 'meetup',
        title: 'Большой вечер в центре',
        emoji: '🪩',
        meetupPhase: 'upcoming',
      },
      {
        id: 'evening-chat-r-quiet-soul',
        kind: 'meetup',
        origin: 'meetup',
