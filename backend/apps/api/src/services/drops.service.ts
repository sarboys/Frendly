...
const TASK_META = {
  verification: {
    ...
    conditionDetails: [
      ...
      'Повторная верификация в том же или следующих месяцах не дает новые билеты.',
    ],
    cta: 'Верификация',
    route: '/verify',
  ...
  host_meeting: {
    ...
    conditionDetails: [
      ...
      'Встреча должна быть создана минимум за 6 часов до старта и не должна быть отменена.',
      'Нужно минимум 3 гостя и минимум 2 гостя с подтвержденным присутствием.',
      'Максимум 5 билетов за такие встречи в месяц.',
    ],
    cta: 'Создать',
    route: '/meetings/new',
  },
    ...
    const hasSubscriptionReward = rewards.some(
      ...
      return {
        ...
        return {
          ...
          progress: current,
          status,
          conditionDetails: [...meta.conditionDetails],
          cta,
          lockReason,
        };
      }),
