...
- Default scheduled content sources are `kudago,timepad,advcake_ticketland`. Default production cities are `Москва,Санкт-Петербург,Екатеринбург,Нижний Новгород,Казань`. Overpass and Tomesto code remain available for explicit/manual import, but they are not in the default scheduled source list.
