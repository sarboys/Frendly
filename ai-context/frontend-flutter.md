...
- Local-first is gated by `BIG_BREAK_LOCAL_FIRST_CACHE`; default is enabled outside release. `localFirstCacheEnabledProvider` can disable providers, and DB open failure sets `appLocalCacheRuntimeDisabledProvider`.
