...
- Own profile includes a red SOS icon in the header plus V5 quick entries for verification, SOS and notifications. The notifications row uses `notificationUnreadCountProvider`; do not hardcode the badge.
