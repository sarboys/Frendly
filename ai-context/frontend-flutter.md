...
- Own profile includes a red SOS icon in the header plus V5 quick entries for Frendly+, Wallet, verification and SOS. Token balance, top-up, payment return and history live under Wallet; old `/tokens/*` deep links redirect there.
